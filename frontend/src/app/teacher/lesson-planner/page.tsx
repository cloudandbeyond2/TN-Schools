              ...
              <div className="w-full h-full flex flex-col">
                ...
                {activeTab === "overview" && (
                  <div className="flex-1 space-y-6">
                    ...
                    {/* Concept Explanation */}
                    {currentPlan.planData?.conceptExplanation && (() => {
                      const conceptData = currentPlan.planData.conceptExplanation;
                      return (
                        <div className={`p-6 rounded-3xl border ${theme.border} ${theme.bgCard} shadow-sm overflow-hidden`}>
                          <SectionHeader icon="fi-sr-book-alt" tint="text-rose-600" soft="bg-rose-500/10" kicker="Deep Dive" title="Concept Explanation" />
                          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-[3rem] p-8 sm:p-12 min-h-[800px] border border-slate-200 dark:border-slate-700 shadow-inner flex items-center justify-center relative overflow-hidden mt-4">
