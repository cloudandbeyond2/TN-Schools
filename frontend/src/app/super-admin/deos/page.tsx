        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-5">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            ...
            <button
              ...
              className="px-4 py-2 bg-purple-650 hover:bg-purple-550 text-white text-xs font-bold rounded-xl transition-all shadow-md shrink-0"
            >
              + Add DEO
            </button>
          </div>
          ...
          <div className="w-full max-w-md rounded-3xl p-6 space-y-5 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 shadow-2xl relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-2.5 bg-purple-600 hover:bg-purple-550 disabled:bg-slate-850 text-white font-bold rounded-xl text-xs transition-colors shadow-md mt-2"
              >
