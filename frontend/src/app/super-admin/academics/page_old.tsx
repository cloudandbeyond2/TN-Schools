...
import { FiEdit2, FiTrash2, FiPlus, FiX, FiSearch, FiFilter } from "react-icons/fi";
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-200 dark:border-slate-800/60">
            <div>
              ...
              >
                Manage subjects, syllabus, and study materials efficiently.
              </motion.p>
            </div>
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 hide-scrollbar">
            {TABS.map((tab) => (
              <button
                ...
                className={`px-5 py-2.5 rounded-xl whitespace-nowrap font-bold text-sm transition-all duration-200 ${
                  activeTab === tab.id
                  ...
                  {filteredSubjects.map((sub, idx) => (
                    ...
                    >
                      ...
                      <div className="absolute top-3 right-3 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button onClick={() => openSubjectModal(sub)} className="p-2 text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 rounded-lg transition-colors">
                          <FiEdit2 size={16} />
                        </button>
                        <button onClick={() => handleDeleteSubject(sub.id)} className="p-2 text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors">
                          <FiTrash2 size={16} />
                        </button>
                      </div>
                    </motion.div>
                  ...
                  {filteredResources.map((res, idx) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 w-full sm:w-auto justify-end opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                        <button onClick={() => openResourceModal(res)} className="p-2.5 bg-white dark:bg-slate-800 rounded-lg text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 shadow-sm border border-slate-200 dark:border-slate-700 transition-colors">
                          <FiEdit2 size={18} />
                        </button>
                        <button onClick={() => handleDeleteResource(res.id)} className="p-2.5 bg-white dark:bg-slate-800 rounded-lg text-slate-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-500/10 shadow-sm border border-slate-200 dark:border-slate-700 transition-colors">
                          <FiTrash2 size={18} />
                        </button>
                      </div>
                    </motion.div>
