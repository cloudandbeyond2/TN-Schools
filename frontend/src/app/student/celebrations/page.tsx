            ...
            <div className="flex border-b border-slate-200 dark:border-slate-800">
              <button
                ...
                className={`flex-1 px-4 py-4 text-sm font-medium flex items-center justify-center gap-2 transition-all focus:outline-none border-b-2 ${activeTab === "today"
                  ...
                  : "border-transparent text-slate-500 hover:text-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/50 dark:text-slate-400"
                  }`}
              >
                ...
                <div className="space-y-4">
                  ...
                  {!isLoading && todayCelebrations.length === 0 && (
                    <div className="py-12 flex flex-col items-center justify-center text-center">
                      ...
                      <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">No events today</h3>
                ...
                <div className="space-y-4">
                  ...
                  {!isLoading && weekCelebrations.length === 0 && (
                    <div className="py-12 flex flex-col items-center justify-center text-center">
                      ...
                      <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">No events scheduled</h3>
                      <p className="text-sm text-slate-550 mt-2 font-medium">There are no upcoming events at the moment.</p>
                    </div>
                  )}
                ...
                <div className="space-y-8">
                  ...
                  {!isLoading && holidays.length === 0 && (
                    <div className="py-12 flex flex-col items-center justify-center text-center">
                      ...
                      <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">No holidays listed</h3>
                      <p className="text-sm text-slate-550 mt-2 font-medium">No official holidays have been scheduled yet.</p>
                    </div>
                  )}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4 transition-all duration-300">
          <div className="bg-white dark:bg-slate-900 rounded-3xl w-full max-w-4xl shadow-2xl border border-slate-200 dark:border-slate-800 p-6 relative flex flex-col max-h-[90vh]">
            ...
            <button
              ...
              className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500 hover:text-slate-850 dark:hover:text-slate-200 transition-colors"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 overflow-y-auto pr-1">
              ...
              <div className="lg:col-span-7 flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-800/40 p-3 rounded-xl border border-slate-200/60 dark:border-slate-800">
                  <button
                    ...
                    className="p-2 bg-white dark:bg-slate-800 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-350"
                  >
                ...
                <div className="flex gap-4 text-xs mt-2 border-t border-slate-100 dark:border-slate-800 pt-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-slate-500 dark:text-slate-400 font-medium">School Event</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-full bg-amber-500 animate-none"></span>
                    <span className="text-slate-500 dark:text-slate-400 font-medium">Govt Holiday</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 flex flex-col gap-4 border-t lg:border-t-0 lg:border-l border-slate-200 dark:border-slate-800 pt-4 lg:pt-0 lg:pl-6 min-h-[300px]">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-[10px] font-bold text-slate-500 dark:text-slate-400 rounded-md">
                  ...
                  {eventsInSelectedMonth.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center py-8">
                      ...
                      <button
                        ...
                        className="mt-3 px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-950/30 dark:hover:bg-indigo-950/50 text-indigo-700 dark:text-indigo-400 text-[11px] font-bold rounded-lg transition-colors flex items-center gap-1.5 border border-indigo-100 dark:border-indigo-900"
                      >
                      ...
                      <div className="flex items-center gap-2 mb-1.5">
                        <span className={`px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider ${
                          selectedDayEvent.type === "HOLIDAY" 
                            ...
                            : "bg-indigo-100 text-indigo-850 dark:bg-indigo-950/30 dark:text-indigo-300"
                        }`}>
