          ...
          <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-[2.5rem] shadow-lg border-4 border-rose-100 dark:border-slate-700 overflow-hidden">
            <div className="flex bg-rose-50 dark:bg-slate-900 p-2 gap-2 flex-wrap sm:flex-nowrap">
              <button
                ...
                className={`flex-1 min-w-[80px] sm:min-w-0 px-2 py-3 sm:px-4 md:px-6 md:py-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-black flex items-center justify-center gap-1.5 sm:gap-2 rounded-2xl transition-all focus:outline-none ${activeTab === "today"
              ...
              <button
                ...
                className={`flex-1 min-w-[80px] sm:min-w-0 px-2 py-3 sm:px-4 md:px-6 md:py-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-black flex items-center justify-center gap-1.5 sm:gap-2 rounded-2xl transition-all focus:outline-none ${activeTab === "week"
                  ? "bg-rose-500 text-white border-2 border-rose-500 shadow-md shadow-rose-500/20"
                  : "bg-white dark:bg-slate-800 text-slate-500 hover:bg-rose-100 hover:text-rose-600 border-2 border-slate-100 dark:border-slate-700"
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 min-w-[80px] sm:min-w-0 px-2 py-3 sm:px-4 md:px-6 md:py-4 text-[10px] sm:text-xs md:text-sm lg:text-base font-black flex items-center justify-center gap-1.5 sm:gap-2 rounded-2xl transition-all focus:outline-none ${activeTab === "holiday"
                  ? "bg-rose-500 text-white border-2 border-rose-500 shadow-md shadow-rose-500/20"
                  : "bg-white dark:bg-slate-800 text-slate-500 hover:bg-rose-100 hover:text-rose-600 border-2 border-slate-100 dark:border-slate-700"
                  }`}
              >
                ...
                <div className="space-y-6">
                  ...
                  {!isLoading && todayCelebrations.length === 0 && (
                    <div className="py-12 flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-xs font-bold text-slate-550 mt-1">Check out the All Scheduled Events tab for other events!</p>
                    </div>
                  )}
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] shadow-lg border-4 border-amber-100 dark:border-slate-700 h-fit relative">
            ...
            <div className="space-y-4">
              {preparations.map((prep) => (
                <div key={prep.id} className={`p-4 rounded-2xl border-4 ${prep.status === 'Completed' ? 'bg-emerald-50 border-emerald-200 dark:bg-emerald-900/20 dark:border-emerald-800' :
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider border-2 shadow-sm ${prep.status === 'Completed' ? 'bg-emerald-100 text-emerald-700 border-emerald-300' :
              ...
              {Array.from({ length: new Date(currentYear, currentMonth + 1, 0).getDate() }).map((_, i) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    className={`aspect-square rounded-xl font-bold text-sm flex flex-col items-center justify-center relative transition-all ${isHoliday
              ...
              {selectedDayEvent ? (
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className={`px-2 py-0.5 rounded-lg text-[10px] font-black text-white uppercase tracking-wider ${selectedDayEvent.type === "HOLIDAY" ? "bg-amber-500" : "bg-pink-500"
                      }`}>
