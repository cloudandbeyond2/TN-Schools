    ...
    >
      <div className="flex flex-col gap-8 text-left animate-in fade-in duration-300">
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-green-500 to-emerald-700 text-white p-8 shadow-xl border-4 border-green-200">
          <div className="absolute top-[-50px] right-[-50px] w-64 h-64 bg-yellow-300/30 rounded-full blur-3xl text-left pointer-events-none"></div>
          <div className="absolute bottom-[-50px] right-[10%] w-48 h-48 bg-emerald-900/40 rounded-full blur-2xl text-left pointer-events-none"></div>
