              ...
              <div className="border-t border-slate-150 dark:border-slate-800 pt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  {isMember ? (
                    ...
                    <span className="px-4 py-2 bg-slate-100 dark:bg-slate-800/60 text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-700/60 rounded-xl text-xs font-semibold flex items-center justify-center gap-1 shrink-0">
                      Enrolled by HM / PET Staff
                    </span>
                  )}
                </div>
              </div>
