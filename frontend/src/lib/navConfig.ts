...
export const roleConfigs: Record<string, PortalConfig> = {
  ...
  STUDENT_MIDDLE: {
    ...
    navItems: [
      ...
      { label: "My Health Report", href: "/student/health", icon: "🏥" },
      { label: "Leave Reports", href: "/student/leave", icon: "📄" },
      ...
      { label: "Zoology Centre", href: "/student/zoology-centre", icon: "🐸" },
      { label: "3D Preview", href: "/student/3d-preview", icon: "🧊" },
      { label: "Celebrations", href: "/student/celebrations", icon: "🎉" },
      { label: "Cultural Events", href: "/student/cultural-events", icon: "🎭" },
      { label: "Computer Education", href: "/student/computer-education", icon: "💻" },
      { label: "School Press", href: "/student/school-press", icon: "📰" },
    ],
  },
  STUDENT_HIGH: {
  ...
  PARENT: {
    ...
    navItems: [
      ...
      { label: "Child Health Report", href: "/student/health", icon: "🏥" },
      { label: "Leave Reports", href: "/parent/leave", icon: "📄" },
