...
export const roleConfigs: Record<string, PortalConfig> = {
  ...
  HEADMASTER: {
    ...
    accentColor: "#3b82f6",
    navItems: [
      { label: "Dashboard", href: "/headmaster", icon: "Home" },
      ...
      { label: "Rewards & Honors", href: "/headmaster/rewards", icon: "Trophy" },
      { label: "School History", href: "/headmaster/history", icon: "ScrollText" },
      { label: "Clubs & Activities", href: "/headmaster/clubs", icon: "Smile" },
    ],
  },
  BEO: {
